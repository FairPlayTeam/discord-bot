...
export class JsonStore {
	...
	increaseInfiniteRoad(guildId) {
		this.data[guildId] = this.data[guildId] || {}
		this.data[guildId].infinite_road = this.data[guildId].infinite_road || {}
		this.data[guildId].infinite_road.count = this.data[guildId].infinite_road.count || 0
		this.data[guildId].infinite_road.count++
		return this.save()
	}
	
	resetInfiniteRoad(guildId) {
		this.data[guildId] = this.data[guildId] || {}
		this.data[guildId].infinite_road = this.data[guildId].infinite_road || {}
		delete this.data[guildId].infinite_road.last_user_id
		this.data[guildId].infinite_road.count = 0
		return this.save()
	}

	setInfiniteRoadLastUserId(guildId, userId) {
		this.data[guildId] = this.data[guildId] || {}
		this.data[guildId].infinite_road = this.data[guildId].infinite_road || {}
		this.data[guildId].infinite_road.last_user_id = userId
		return this.save()
	}

	getInfiniteRoadCount(guildId) {
		this.data[guildId] = this.data[guildId] || {}
		this.data[guildId].infinite_road = this.data[guildId].infinite_road || {}
		return this.data[guildId].infinite_road.count || 0
	}

	getInfiniteRoadLastUserId(guildId) {
		this.data[guildId] = this.data[guildId] || {}
		this.data[guildId].infinite_road = this.data[guildId].infinite_road || {}
		return this.data[guildId].infinite_road.last_user_id || null
	}
}
